...
class TextProcessor:
    ...
    def process_text(self, text: str, source: str = "direct input") -> None:
        ...
        prompt = PromptTemplate(
            ...
            template="""
            You are an expert note-taker. Given the following text, please:
            ...
            3. Format the output as a JSON object with the following structure:
            {
                ...
                "notes": [
                    {
                        "topic": "topic1",
                        "content": "detailed notes about topic1",
                        "source": "text source",
